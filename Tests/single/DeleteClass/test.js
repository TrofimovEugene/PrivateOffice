...
await page.click(`body > div > main > form:nth-child(4) > table > tbody > tr:nth-child(${numbclass}) > td:nth-child(7) > div > input.btn.btn-outline-danger.ml-auto.bd-highlight`)
await page.waitFor(timer);
