...
await page.screenshot({path: './screens result/Занятие.png'});
await page.waitFor(timer);
...
await page.waitFor(timer);
await searchTime.click({clickCount: 10});
await page.waitFor(timer);
...
await page.screenshot({path: './screens result/Редактирование занятия.png'});
await page.waitFor(timer);
